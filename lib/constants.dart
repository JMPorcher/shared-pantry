...
Pantry kTestPantry = Pantry(title: 'Persönlich', categories: [kTestCategory, kTestCategory4, kTestCategory5], pantryID: 'testPantryID', founderID: 'testFounderID', moderatorIds: ['testModeratorID']);
Pantry kTestPantry2 = Pantry(title: 'WG', categories: [kTestCategory2], pantryID: 'testPantryID', founderID: 'testFounderID', moderatorIds: ['testModeratorID']);
Pantry kTestPantry3 = Pantry(title: 'Werkzeug', categories: [kTestCategory3], pantryID: 'testPantryID', founderID: 'testFounderID', moderatorIds: ['testModeratorID']);
