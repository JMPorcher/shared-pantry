...
class PantryProvider extends StatelessWidget {
  ...
  PantryProvider({required this.pantryId, required this.child, required this.uid});

  @override
  Widget build(BuildContext context) {
  return StreamProvider<Pantry>(
  create: (context) =>
  DatabaseService(uid).streamPantryDetails(pantryId),
  initialData: Pantry(moderatorIds: [], title: '', pantryID: '', founderID: ''
