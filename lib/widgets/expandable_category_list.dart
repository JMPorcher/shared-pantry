      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Slidable(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: Colors.grey, boxShadow: const [BoxShadow(offset: Offset(3, 3), blurStyle: BlurStyle.normal, blurRadius: 5)]),
